...
class dynamic_pcell(dynamic_pcell_base, ihp_base_definitions, DeviceBase):
    ...
    def defineParamSpecs(cls, specs):
        ...
        specs('drains_to_tap_devices', '', 'Devices which drains connected to tap', tooltip=descriptions['drains_to_tap_devices'])
        specs('sources_to_tap_devices', '', 'Devices which sources connected to tap', tooltip=descriptions['sources_to_tap_devices'])
