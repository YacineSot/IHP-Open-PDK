...
class dynamic_array(dynamic_array_base, ihp_base_definitions, DeviceBase):
    ...
    def defineParamSpecs(cls, specs):
        ...
        specs('pmos_w', 5e-6, 'PMOS Width', unit='m')
        specs('pmos_l', 3e-6, 'PMOS Length', unit='m')
        specs('nmos_w', 5e-6, 'NMOS Width', unit='m')
        specs('nmos_l' , 3e-6, 'NMOS Length', unit='m')
        ...
        specs('horizontal_spacing', 0.26, 'Horizental Spacing', unit='um')
        ...
        specs('dummy_pmos_l', 0.5e-6, 'Dummy PMOS length', unit='m')
        specs('dummy_nmos_l', 0.5e-6, 'Dummy NMOS length', unit='m')
        specs('dummies_core_spacing', -0.3, 'Distance between core and dummy', unit='um')
        specs('dummies_spacing', 0.2, 'Distance between dummies', unit='um')
